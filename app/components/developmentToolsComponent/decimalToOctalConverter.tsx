...
const DecimalToOctalConverter: React.FC = () => {
  ...
  const onDownload = useCallback(() => {
    ...
    a.href = url; a.download = "decimal-to-octal.txt"; document.body.appendChild(a); a.click(); document.body.removeChild(a); URL.revokeObjectURL(url);
  }, [output]);
          ...
          <div className="md:w-[900px] mx-auto">
            ...
            <div className="grid md:grid-cols-2 grid-cols-1 gap-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-white/80">Output (Octal)</span>
                </div>
