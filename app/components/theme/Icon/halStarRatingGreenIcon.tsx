...
export const HalfStarRatingGreenIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width={18}
      height={17}
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <stop offset={0.526042} stopColor="#00da92" />
          <stop offset={0.526142} stopColor="#00da92" stopOpacity={0} />
          <stop offset={1} stopColor="#00da92" stopOpacity={0} />
        </linearGradient>
      </defs>
    </svg>
  );
