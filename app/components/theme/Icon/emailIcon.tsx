  ...
  >
    <defs>
      <style>
        ...
        svg:hover .hover-path-1 {
          fill: #75cede; /* Hover color for path 1 */
        }
        svg:hover .hover-path-2 {
          fill: #00a6bc; /* Hover color for path 2 */
        }
      `}
      </style>
    </defs>
